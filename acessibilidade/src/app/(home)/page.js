...
const Courses = ({imagePath, title}) => {
  return (
    <div className="flex bg-claro w-full border-cinza border-2 rounded-full py-[8px] px-[16px] items-center mt-2 gap-x-1	dark:bg-cinzaEscuro">
  ...
  return (
    <main className=" flex min-h-screen flex-col items-center justify-between py-16 sm:py-32 sm:px-12 max-w-[1200px] m-auto">
      <section className=" flex flex-wrap-reverse items-center lg:grid lg:grid-cols-2 lg:gap-x-12">  
        <Card className="">
          <h1 className="text-black font-extrabold text-2xl dark:text-white">Desperte o Gênio da Computação em Você!</h1>      
          ...
          <h2 className="text-educk text-lg mt-2">Descubra: <p className="text-base text-black inline-block dark:text-white"> Entenda os fundamentos da computação com materiais claros e objetivos.</p></h2>
          <h2 className="text-educk text-lg mt-2">Aprenda: <p className="text-base text-black inline-block dark:text-white"> Participe de exercícios interativos que estimulam o pensamento crítico.</p></h2>
          <h2 className="text-educk text-lg mt-2">Cresça: <p className="text-base text-black inline-block dark:text-white"> Desenvolva habilidades essenciais para o mercado de tecnologia.</p></h2>
      ...
      <div className="w-full flex justify-center lg:w-auto mb-8">
        ...
        <Card className="w-full">
          <h1 className="text-black font-extrabold text-2xl dark:text-white">Cursos:</h1>
      ...
      <section className="mt-12 flex flex-wrap-reverse w-auto items-center justify-center lg:grid lg:grid-cols-2 lg:gap-x-12">  
        <Card className="w-full">
          <h1 className="text-black font-extrabold text-2xl dark:text-white">Sobre nós:</h1>
